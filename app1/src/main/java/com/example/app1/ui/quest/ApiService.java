...
public class ApiService {
    ...
    private static final String BASE_URL_QUEST = "http://10.0.2.2:8091/gateway/api/quest";
    private static final String BASE_URL_OPERA = "http://10.0.2.2:8091/gateway/api/opera";
    // User service (UserDataModule3) su porta 8080
    private static final String BASE_URL_USER = "http://10.0.2.2:8091/gateway/api/users";
